...
export default async function aiHandlerVerb(req) {
    ...
    const prompt = `
    Я даю тебе глагол ${req}. напиши json объект немецкого глагола. Строго соблюдай структуру. examples приведи от одного до пяти примеров. notes - объяснение должно быть на русском. в ключ verb запиши слово на немецком, а в ключ translation его перевод на русский язык. ниже пример объекта {"verb": "machen",
    "translation": "делать",
    "conjugation": {
        "present": {
            "ich": "mache",
    ...
    "examples": ["Ich mache meine Hausaufgaben.","Er hat das Auto gemacht."],
