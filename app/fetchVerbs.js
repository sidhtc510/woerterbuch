        ...
        history: [
            {
                ...
                parts: [
                    {
                        text: "Я даю тебе глагол. переведи его на немецкий язык. напиши json объект. Строго соблюдай структуру, ключи объекта должны быть в двойных ковычках \" . examples приведи от одного до пяти примеров. notes - объяснение должно быть на русском. ниже пример объекта {\"verb\": \"machen\",\"translation\": \"делать\",\"conjugation\": {\"present\": {\"ich\": \"mache\",\"du\": \"machst\",\"er/sie/es\": \"macht\",\"wir\": \"machen\",\"ihr\": \"macht\",\"sie/Sie\": \"machen\"},\"past\": {\"ich\": \"machte\",\"du\": \"machtest\",\"er/sie/es\": \"machte\",\"wir\": \"machten\",\"ihr\": \"machtet\",\"sie/Sie\": \"machten\"},\"future\": {\"ich\": \"werde machen\",\"du\": \"wirst machen\",\"er/sie/es\": \"wird machen\",\"wir\": \"werden machen\",\"ihr\": \"werdet machen\",\"sie/Sie\": \"werden machen\"},},\"examples\": [\"Ich mache meine Hausaufgaben.\",\"Er hat das Auto gemacht.\"],\"notes\": \"Глагол 'machen' используется в широком спектре значений, включая 'создавать', 'делать' и 'выполнять'.\"} "
                    },
                ],
            },
        ],
