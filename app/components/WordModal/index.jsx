...
export default function WordModal({ wordObj }) {
    ...
    return (
        <>
            ...
            {isModalOpen && (
                <div className={`bg-black bg-opacity-40 backdrop-blur-sm inset-0 z-20 overflow-auto flex justify-center items-center fixed w-full h-full`} onClick={handleCloseModal}>
