    ...
    const handleSubmit = async (e) => {
        ...
        const formedObj = {
            ...
            singular: {
                ...
                genitiv: `${formData.genitiv_artikle} ${formData.genitiv_sing}`,
                dativ: `${formData.dativ_artikle} ${formData.dativ_sing}`,
                akkusativ: `${formData.akkusativ_artikle} ${formData.akkusativ_sing}`
            },
            plural: {
                ...
                <form className="w-full max-w-lg" onSubmit={(e) => handleSubmit(e)}>
                    ...
                    <div className="flex flex-wrap -mx-3 mb-8">
                        <div className="w-full md:w-1/3 px-3 mb-2 md:mb-0">
                            <label className="block uppercase tracking-wide text-gray-700 text-xs mb-2" htmlFor="grid-state">
                                Nominativ
                            </label>
